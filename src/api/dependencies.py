...
def set_database_instance(db: Database): # finding: Is this the correct database instance?
    """Set the global database instance."""
    global _db_instance
    _db_instance = db


def set_database_credentials(user: str, password: str, host: str = None, name: str = None, port: int = None): # finding: Is this a duplicate?
