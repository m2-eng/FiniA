-- ========================================
-- FINIA Database Schema: Initial Schema
-- Description: Complete database initialization with all tables, views, constraints, and triggers
-- Version: 001
-- ========================================
...
CREATE TABLE IF NOT EXISTS `tbl_accountImportFormat` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_accountImportPath` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_accountingEntry` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_accountReserve` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
  `amount` decimal(20,10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_planningCycle` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_planningEntry` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_shareHistory` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
  `amount` decimal(20,10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_shareTransaction` (
  `id` bigint(20) NOT NULL,
  `dateImport` datetime NOT NULL,
...
--
ALTER TABLE IF EXISTS `tbl_accountImportFormat`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_accountImportPath`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_accountingEntry`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_accountReserve`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_accountType`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `type` (`type`);
...
--
ALTER TABLE IF EXISTS `tbl_category`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
...
--
ALTER TABLE IF EXISTS `tbl_loan`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_planning`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_planningCycle`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_planningEntry`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_share`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_shareHistory`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_shareTransaction`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE IF EXISTS `tbl_transaction`
  ADD PRIMARY KEY (`id`),
...
--
CREATE VIEW IF NOT EXISTS `view_sharePortfolioValue` AS
SELECT
  s.id,
  s.name,
  s.isin,
...
--
CREATE VIEW IF NOT EXISTS `view_shareMonthlySnapshot` AS
...
--
DROP TRIGGER IF EXISTS `trg_transaction_create_accounting_entry`;
DELIMITER $$
